...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'de0e1124d0b0461f8f75e03c03480a7a',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是宋宵因,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '宋宵因', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '生物技术应用工程师，文学爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cz9.work', // 网站地址
